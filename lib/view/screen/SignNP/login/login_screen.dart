...
import 'package:psychepulse/view/screen/SignNP/login/cubit/cubit.dart';
import 'package:psychepulse/view/screen/SignNP/login/cubit/states.dart';
import 'package:psychepulse/view/screen/SignNP/register/register_screen.dart';
...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create:  (BuildContext context) => LoginCubit()..language(),
        ...
        builder:(BuildContext context, LoginStates state){
          return Scaffold(
            body: ModalProgressHUD(
              inAsyncCall: LoginCubit.get(context).showSpin,
              child: Form(
                key: _formKey,
                child: Container(
                  color: Colors.white,
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: DropdownButton<String>(
                                  ...
                                  iconSize: 30,
                                  value: LoginCubit.get(context).selectedValue,
                                  onChanged: (String? newValue) {
                                    LoginCubit().Selectlanguage(newValue);
                                  },
